...
public class ShapeRedio extends Application{
	...
	public void start(Stage stage) throws Exception
	{
		...
		RadioButton b1 = new RadioButton("Circle");
		RadioButton b2 = new RadioButton("Rectangle");
		RadioButton b3 = new RadioButton("Square");
